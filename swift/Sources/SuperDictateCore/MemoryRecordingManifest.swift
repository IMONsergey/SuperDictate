...
public struct SuperDictateMemoryAudioChunk: Identifiable, Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case id, source, sequence, relativePath
        case sessionStartMilliseconds, sessionEndMilliseconds
        case container, codec, sampleRate, channelCount, byteLength, sha256
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            sha256: c.decode(String.self, forKey: .sha256)
        )
    }
...
public struct SuperDictateMemoryRecordingManifest: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case recordingID, createdAt, state, chunks, issue
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            state: c.decode(SuperDictateMemorySessionState.self, forKey: .state),
            chunks: c.decode([SuperDictateMemoryAudioChunk].self, forKey: .chunks),
            issue: c.decodeIfPresent(String.self, forKey: .issue)
        )
    }
