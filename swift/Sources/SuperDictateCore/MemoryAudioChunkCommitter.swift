...
/// Encoding-neutral durability transaction for a fully closed CAF chunk.
public actor SuperDictateMemoryAudioChunkCommitter {
    ...
    public func commitChunk(
        ...
        do {
            ...
            // The manifest is already authoritative. This marker is best-effort;
            // when it exists it makes later manifest reconstruction SHA-bound.
