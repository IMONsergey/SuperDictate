...
///
/// The caller owns timestamp conversion into the shared Memory host-clock
/// timeline. This type only validates/copies authoritative audio bytes. It
/// accepts Linear PCM Float32 in either interleaved or non-interleaved layout.
